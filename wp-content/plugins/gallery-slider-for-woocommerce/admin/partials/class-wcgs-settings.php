	...
	public static function options( $prefix ) {
		WCGS::createOptions(
			...
			array(
				...
				<div class='wcgs-popup-content'><h2> <i class='icon-sp_wgs-lock'></i> Available in Pro</h2><p>" . __( 'Please upgrade to the Pro version  to unlock all these amazing features.', 'gallery-slider-for-woocommerce' ) . "</p> <p><a href='" . esc_url( WOO_GALLERY_SLIDER_PRO_LINK ) . "' target='_blank' class='btn'>" . __( 'Get the Pro version', 'gallery-slider-for-woocommerce' ) . '</a></p></div></div><div id="myOnPageContent" style="display: none;"> <div class="wcgs-popup-content"><h2> <i class="icon-sp_wgs-lock"></i> Available in Pro</h2><p>Please upgrade to the Pro version  to unlock all these amazing features</p> <p><a target="_blank" href=' . esc_url( WOO_GALLERY_SLIDER_PRO_LINK ) . ' class="btn">Get the Pro version</a></p></div> </div>',
			)
		);
