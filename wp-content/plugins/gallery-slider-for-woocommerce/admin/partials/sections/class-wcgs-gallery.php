			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'options'    => array(
							'angle'          => array(
								'option_name' => '<i class="icon-sp_wgs-left-open-1"></i>',
							),
							'chevron'        => array(
								'option_name' => '<i class="icon-sp_wgs-left-open"></i>',
								'pro_only'    => true,
							),
							'angle_double'   => array(
								'option_name' => '<i class="icon-sp_wgs-angle-double-left"></i>',
								'pro_only'    => true,
							),
							'chevron_circle' => array(
								'option_name' => '<i class="icon-sp_wgs-left-circle-1"></i>',
								'pro_only'    => true,
							),
							'arrow'          => array(
								'option_name' => '<i class="icon-sp_wgs-arrow-left"></i>',
								'pro_only'    => true,
							),
							'long_arrow'     => array(
								'option_name' => '<i class="icon-sp_wgs-left-thin"></i>',
								'pro_only'    => true,
							),
							'arrow_circle'   => array(
								'option_name' => '<i class="icon-sp_wgs-left-circled"></i>',
								'pro_only'    => true,
							),
							'arrow_circle_o' => array(
								'option_name' => '<i class="icon-sp_wgs-left-circled-1"></i>',
								'pro_only'    => true,
							),
						),
						'default'    => 'angle',
