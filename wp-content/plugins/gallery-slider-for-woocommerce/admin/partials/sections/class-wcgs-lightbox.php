			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'options'    => array(
							'search'      => array(
								'option_name' => '<i class="icon-sp_wgs-search"></i>',
							),
							'search-plus' => array(
								'option_name' => '<i class="icon-sp_wgs-search-plus"></i>',
								'pro_only'    => true,
							),
							'eye'         => array(
								'option_name' => '<i class="icon-sp_wgs-eye"></i>',
								'pro_only'    => true,
							),
							'plus'        => array(
								'option_name' => '<i class="icon-sp_wgs-plus"></i>',
								'pro_only'    => true,
							),
							'info'        => array(
								'option_name' => '<i class="icon-sp_wgs-info"></i>',
								'pro_only'    => true,
							),
							'angle-right' => array(
								'option_name' => '<i class="icon-sp_wgs-right-open-1"></i>',
								'pro_only'    => true,
							),
							'expand'      => array(
								'option_name' => '<i class="icon-sp_wgs-expand-alt"></i>',
								'pro_only'    => true,
							),
							'arrows-alt'  => array(
								'option_name' => '<i class="icon-sp_wgs-resize-full-alt"></i>',
								'pro_only'    => true,
							),
						),
						'default'    => 'search',
