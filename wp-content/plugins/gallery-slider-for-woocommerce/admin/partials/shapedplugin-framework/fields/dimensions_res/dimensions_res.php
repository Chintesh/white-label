	...
	class WCGS_Field_dimensions_res extends WCGS_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['width'] ) ) {
				...
				echo ( ! empty( $args['width_icon'] ) ) ? '<span class="wcgs--label wcgs--label-icon icon-sp_wgs-laptop-1"></span>' : '';
			...
			if ( ! empty( $args['height'] ) ) {
				...
				echo '<div class="wcgs--input">';
				echo ( ! empty( $args['height_icon'] ) ) ? '<span class="wcgs--label wcgs--label-icon icon-sp_wgs-tablet-1"></span>' : '';
			...
			if ( ! empty( $args['height2'] ) ) {
				...
				echo '<div class="wcgs--input">';
				echo ( ! empty( $args['height2_icon'] ) ) ? '<span class="wcgs--label wcgs--label-icon icon-sp_wgs-mobile"></span>' : '';
