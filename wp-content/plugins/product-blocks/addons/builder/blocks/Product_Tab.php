    ...
    public function get_attributes($default = false){
        ...
        $attributes = array(
            ...
            'labelBg' => [
                ...
                'style' =>[
                    (object)[
                        'selector'=>'{{WOPB}} .woocommerce-product-attributes-item__label , .woocommerce {{WOPB}} table.shop_attributes tr:nth-child(even) th , .woocommerce {{WOPB}} table.shop_attributes tr > th{background:{{labelBg}};}'
                    ]
                ],
            ],
            // additional value
                ...
                'style' => [
                     (object)[
                        'selector'=>'
                            ...
                            .woocommerce {{WOPB}} table.shop_attributes tr > td {background:{{addInfoValueBg}};}
                        ',
